...
QT_MOC_LITERAL(1, 9, 13), // "SignalAuthBtn"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "SignalRegBtn"
QT_MOC_LITERAL(4, 37, 11), // "SlotAuthBtn"
QT_MOC_LITERAL(5, 49, 10) // "SlotRegBtn"

    },
    "AuthForm\0SignalAuthBtn\0\0SignalRegBtn\0"
    "SlotAuthBtn\0SlotRegBtn"
};
...
void AuthForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalAuthBtn((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->SignalRegBtn((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->SlotAuthBtn(); break;
        case 3: _t->SlotRegBtn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AuthForm::SignalAuthBtn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AuthForm::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AuthForm::SignalRegBtn)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AuthForm::SignalAuthBtn(QString _t1)
{
...
// SIGNAL 1
void AuthForm::SignalRegBtn(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
